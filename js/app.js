...
(async function App() {
    ...
    function updateStaticText() {
        ...
        if (heroTitle) {
            // The light variant, not --ir-primary: on the dark hero photo the
            // turquoise measures 1.8-3.0:1. See governance/README.md.
            heroTitle.innerHTML = i18n.getLanguage() === 'he' ?
                'המטבח <span class="text-ir-primary-light">הפרסי</span>' :
                '<span class="text-ir-primary-light">Persian</span> Kitchen';
        }
        ...
        if (footerText) {
            footerText.innerHTML = i18n.t('footer.tagline') + ' <span class="text-ir-primary-light mx-1"><i class="fas fa-heart"></i></span>';
        }
